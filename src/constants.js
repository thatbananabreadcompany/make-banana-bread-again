...
export const DISCLAIMER = "All rankings and ratings on this website are based on community submissions and opinions. They are provided for informational and entertainment purposes only and do not represent professional reviews, endorsements, or any measure of business performance.";
...
export const FLAG_REASONS=["Permanently closed","Wrong information (name, location, category)","Incorrect dietary tags","Banana bread no longer on their menu","Duplicate listing","Other"];
